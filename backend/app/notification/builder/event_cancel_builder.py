...
class EventCancelBuilder(EmailBuilder):
    def __init__(self, message: Message):
        # Check message type is EVENT_CANCELLED
        if message.get_type() != MessageType.EVENT_CANCELLED:
            raise ValueError("System Error:Message type is not EVENT_CANCELLED")
